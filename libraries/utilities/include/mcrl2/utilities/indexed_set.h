...
private:
  ...
  struct alignas(64) put_in_hashtable_statistics
  {
    ...
    std::uint64_t reserve_good_lock_nanoseconds = 0;
    std::uint64_t reserve_good_locks = 0;
    std::uint64_t reserve_bad_lock_nanoseconds = 0;
    std::uint64_t reserve_bad_locks = 0;
